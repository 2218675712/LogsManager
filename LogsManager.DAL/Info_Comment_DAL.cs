...
{
	/// <summary>
	/// 数据访问类:Info_Comment_DAL
	/// </summary>
	public partial class Info_Comment_DAL
	{
		public Info_Comment_DAL()
		{}
		#region  BasicMethod
		...
		public bool Exists(Guid CommentID)
		{
			...
			strSql.Append("select count(1) from Info_Comment");
		...
		public bool Delete(Guid CommentID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Info_Comment ");
			strSql.Append(" where CommentID=@CommentID ");
			SqlParameter[] parameters = {
					new SqlParameter("@CommentID", SqlDbType.UniqueIdentifier,16)			};
			parameters[0].Value = CommentID;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select CommentID,LogsID,CommentContent,Commentator,CommentTime,IsDelete ");
			strSql.Append(" FROM Info_Comment ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Info_Comment T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Info_Comment";
